...
<head>
    ...
    <title>SUST Online</title>
</head>

<body>
    <nav class="navbar navbar-dark bg-dark">
        <a class="navbar-brand" href="#">
            <img src="images/online.png" width="30" height="30" class="d-inline-block align-top" alt="">
            SUST Online Services
        </a>
        <form class="form-inline my-2 my-lg-0">
            <button class="btn btn-outline-info my-2 my-sm-0" type="button" onclick="window.location.href = 'http://code.sust.com/';">New Federation</button>
        </form>
    </nav>
    ...
    <div class="container">
        ...
        <div class="card-deck">
            ...
            <div class="card border-secondary">
                <img src="images/rps.png" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title"><a href="http://sp1.sust.com/rps.php">Online RPS</a></h5>
